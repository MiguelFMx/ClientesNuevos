            ...
            <div class="col-md-12">
                <div class="table-responsive">
                    <div class="card">
                        ...
                        <asp:Table ID="tDocumentos" runat="server" CssClass="table table-striped table-bordered table-hover">
                            <asp:TableHeaderRow CssClass="cabezal" HorizontalAlign="Center">
