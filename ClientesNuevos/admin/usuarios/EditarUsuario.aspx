<%@ Page Title="Editar" Language="C#" MasterPageFile="~/admin/AdminTemplate.Master" AutoEventWireup="true" CodeBehind="EditarUsuario.aspx.cs" Inherits="ClientesNuevos.admin.usuarios.EditarUsuario" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div class="row">
     ...
     <div class="row">
        <div class="col">
        <a href="../usuarios/Lista_usuarios.aspx" class="btn btn-secondary mb-3 d-flex" style="position: fixed; bottom: 3px;"><i class="bi bi-chevron-left"></i>Lista de usuarios</a>
        </div>
    </div>
