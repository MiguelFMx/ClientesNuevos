    ...
    <div class="container">
        ...
        <section>
            <article style="text-align:justify">
                ...
                <section id="pg5">
                <p style="margin-left:40px;"><strong>Procedimientos de seguimiento y supervisión de vehículos</strong> <br />
                ...
                <ul >
                    <li>
                        <strong>Empaque de remolques</strong> <br />
                    ...
                    <li>
                        <strong>Traspaso de remolques</strong> <br />
                    ...
                    <li>
                        <strong>Medidas contra las conspiraciones internas</strong> <br />
                    ...
                    <li>
                        <strong>Procesamiento de documentación</strong> <br />
                    ...
                    <li>
                        <strong>Examen de documentos</strong> <br />
                ...
                <section id="pg8">
                <p><strong style="text-decoration:underline">Seguridad física</strong>
                    <br />
                ...
                <ul>
                    ...
                    <li>
                        <strong>Control de cerraduras y llaves</strong> <br />
